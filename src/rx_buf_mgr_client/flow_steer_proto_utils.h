...
#ifndef NET_GPUDIRECTTCPX_SOCK_FLOW_STEER_PROTO_UTILS_H_
#define NET_GPUDIRECTTCPX_RXBUFMGRCLIENT_FLOW_STEER_PROTO_UTILS_H_
...
#endif  // NET_GPUDIRECTTCPX_RXBUFMGRCLIENT_FLOW_STEER_PROTO_UTILS_H_